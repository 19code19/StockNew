...
const COLUMN_SPECS: Array<ColDef & { formatter?: FormatterType }> = [
  ...
  { field: 'totalTradedVolume', headerName: 'Volume', formatter: 'number', wrapHeaderText: true, autoHeaderHeight: true, width: 90 },
  { field: 'totalTradedValue', headerName: 'Turnover', formatter: 'currency', wrapHeaderText: true, autoHeaderHeight: true, width: 120 },
  { field: 'quantityTraded', headerName: 'Qty Traded', formatter: 'number', wrapHeaderText: true, autoHeaderHeight: true, width: 90 },
  { field: 'deliveryQuantity', headerName: 'Delivery Qty', formatter: 'number', wrapHeaderText: true, autoHeaderHeight: true, width: 75 },
  { field: 'totalMarketCap', headerName: 'Market Cap', formatter: 'currency', wrapHeaderText: true, autoHeaderHeight: true, width: 140 },

...
export const createMutualFundColumns = (): ColDef[] => [
  ...
  { field: 'return6M', headerName: '6M', minWidth: 80, flex: 1, filter: 'agNumberColumnFilter' },
  { field: 'return1Y', headerName: '1Y', minWidth: 80, flex: 1, filter: 'agNumberColumnFilter' },
